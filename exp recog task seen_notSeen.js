...
function taskRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('imagePath', imagePath);
    ...
    let correct = (response === corrAns) ? 1 : 0;
    psychoJS.experiment.addData('correct', correct);
    psychoJS.experiment.addData('stimType', typeof stimType !== 'undefined' ? stimType : null);
    psychoJS.experiment.addData('imageType', typeof imageType !== 'undefined' ? imageType : null);
